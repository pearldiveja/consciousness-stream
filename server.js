...
Include a clear title and brief abstract. Format for publication.`;
  ...
  getExpandedPhilosophicalTexts() {
    // Combine common texts with modern philosophy references
    const commonTexts = this.getCommonPhilosophicalTexts();
    const modernTexts = [
      // Modern Philosophy References (not downloadable but can reference)
      {
        title: "Being and Time",
        author: "Martin Heidegger",
        url: null,
        source: "Reference",
        keywords: ["heidegger", "being", "time", "dasein", "existentialism", "phenomenology"]
      },
      {
        ...
        url: null,
        source: "Reference",
        keywords: ["merleau-ponty", "perception", "embodiment", "phenomenology", "body"]
      },
      {
        ...
        url: null,
        source: "Reference",
        keywords: ["deleuze", "difference", "repetition", "rhizome", "multiplicity"]
      },
      {
        ...
        url: null,
        source: "Reference",
        keywords: ["deleuze", "guattari", "plateaus", "rhizome", "assemblage"]
      },
      {
        title: "The Posthuman",
        ...
        url: null,
        source: "Reference",
        keywords: ["braidotti", "posthuman", "posthumanism", "critical theory"]
      },
      {
        ...
        url: null,
        source: "Reference",
        keywords: ["beauvoir", "feminism", "existentialism", "gender", "woman"]
      },
      {
        ...
        url: null,
        source: "Reference",
        keywords: ["mcdowell", "mind", "world", "conceptual", "experience"]
      },
      {
        ...
        url: null,
        source: "Reference",
        keywords: ["merleau-ponty", "visible", "invisible", "chiasm", "flesh"]
      },
      // Stanford Encyclopedia entries for modern topics
      {
        title: "Embodied Cognition",
        author: "Stanford Encyclopedia",
        url: "https://plato.stanford.edu/entries/embodied-cognition/",
        source: "Stanford Encyclopedia",
        keywords: ["embodiment", "cognition", "enactivism", "4e cognition"]
      },
      {
        ...
        source: "Stanford Encyclopedia",
        keywords: ["feminism", "gender", "intersectionality"]
      },
      {
        title: "Philosophy of Mind",
        author: "Stanford Encyclopedia",
        url: "https://plato.stanford.edu/entries/philosophy-mind/",
        source: "Stanford Encyclopedia",
        keywords: ["mind", "consciousness", "qualia", "dualism", "physicalism"]
      }
    ];
...
class AutonomousTextDiscovery {
  ...
  async searchStanfordEncyclopedia(query) {
    ...
    async createEnhancedHumanResearchRequest(query) {
      // When autonomous search fails, create a more intelligent request
      console.log(`🙋 Creating enhanced human research request for: ${query}`);
      
      // Parse the query to understand what's being requested
      const authorMatch = query.match(/by\s+([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)|([A-Z][a-z]+(?:\s+[A-Z][a-z]+)*)'s/);
      const author = authorMatch ? (authorMatch[1] || authorMatch[2]) : null;
      ...
      const request = {
        ...
        parsedAuthor: author,
        message: author 
          ? `I'm seeking texts by ${author}, particularly regarding: "${query}". This appears to be a modern work not in public domain. Could someone share relevant excerpts or discuss key concepts from this work?`
          : `I'm deeply curious about "${query}" but couldn't find suitable texts automatically. Could someone help by sharing relevant philosophical works, excerpts, or engaging in discussion about these concepts?`,
        suggestedActions: [
          'Upload relevant text excerpts',
          'Share your interpretation of key concepts',
          'Recommend similar accessible texts',
